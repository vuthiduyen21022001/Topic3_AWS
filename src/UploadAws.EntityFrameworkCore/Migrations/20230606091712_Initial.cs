...
namespace UploadAws.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SecretAccessKey = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UseCredentials = table.Column<bool>(type: "bit", nullable: false),
                    UseTemporaryCredentials = table.Column<bool>(type: "bit", nullable: false),
                    UseTemporaryFederatedCredentials = table.Column<bool>(type: "bit", nullable: false),
                    ProfileName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ProfilesLocation = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    CreateContainerIfNotExists = table.Column<bool>(type: "bit", nullable: false),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
